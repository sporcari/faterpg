...
class Table(object):
    def config_db(self,pkg):
        tbl =  pkg.table('aspect_type', pkey='code',name_long='Aspect type',name_plural='Aspect types',caption_field='name',lookup=True)
    ...
    def sysRecord_SA(self):
        return self.newrecord(code='SA',
                              name='Situation aspect',
